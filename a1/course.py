...
class Student:
    ...
    answer_dict: dictionary where keys are Question(s) and values are the
         student's Answer(s) to the question
    ...
    def has_answer(self, question: Question) -> bool:
        ...
        if answer is None:
            return False
        elif not answer.is_valid(question):
            return False
        else:
            return True
    ...
    def set_answer(self, question: Question, answer: Answer) -> None:
        ...
        """
        self._answer_dict[question] = answer
    ...
    def get_answer(self, question: Question) -> Optional[Answer]:
        ...
        """
        if question in self._answer_dict:
            return self._answer_dict[question]
        else:
            return None
...
class Course:
    ...
    def get_students(self) -> Tuple[Student, ...]:
        ...
        enrolled_tuple = tuple(sorted_students)
        return enrolled_tuple
